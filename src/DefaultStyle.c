/*
 * $LynxId: DefaultStyle.c,v 1.21 2025/01/06 16:30:50 tom Exp $
 *
...
HTStyleInit(
	       ...
	       HT_FONT + HT_BOLD, 1, HT_BLACK, 0, NULL,
	       0, 0, 0, HT_CENTER, 1, 0, NULL,
	       YES, YES, 1, 1, 0);
...
#endif
	for (p = sheet.styles; p != NULL; p = p->next) {
	    q = HTStyleNew();
	    *q = *p;
	    if (no_margins) {
		q->indent1st = 0;
